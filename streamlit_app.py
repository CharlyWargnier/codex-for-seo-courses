...
def main():
    ...
    with st.sidebar:
        st.caption(
            "Made in 🎈 [Streamlit](https://www.streamlit.io/)&nbsp, by [Vincent Terrasi](https://www.linkedin.com/in/vincent-terrasi/) and [Charly Wargnier](https://www.charlywargnier.com/) for [DatamarketingLabs](https://www.datamarketinglabs.com/)."
        )
